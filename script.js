...
const DONATIONS = [
  ...
  // ── OTHER ──
  {
    ...
    title_ar:  'بناء مسجد في قرية ريفية',
    title_fr:  'Construction d\'une mosquée en zone rurale',
    target_ar: 'قرية تيجيجة — ولاية تكانت',
    target_fr: 'Village de Tidjikja — Wilaya Tagant',
    desc_ar:   'مشروع بناء مسجد صغير في قرية ريفية نائية تفتقر إلى مكان للصلاة. الطاقة الاستيعابية: 150 مصلياً.',
    desc_fr:   'Construction d\'une petite mosquée dans un village rural isolé dépourvu de lieu de prière. Capacité : 150 fidèles.',
    goal_ar:   '650,000 أوقية', goal_fr: '650 000 MRU',
    open_date: '2025-01-10',     close_date: '2025-12-10',
    don_num:   'DON-OT-2025-001', email: 'masjid@jama3a-rouaa.mr',
    assoc:     'جمعية الرعاة',
